<?PHP
$id_categoria = $_GET['per'] ?? FALSE;


$categoria = (new Categoria())->get_x_id($id_categoria);

$nombre = $categoria->getNombre(TRUE);

/*cataálogo de este categoría*/
$catalogo = (new Perfume())->catalogo_x_categoria($id_categoria);

?>
<div class=" d-flex justify-content-center p-5">
    <div class="container">

        <h1 class="text-center mb-5 fw-bold">Nuestro Catálogo de perfume <span class="text-secondary"><?= $nombre ?></span></h1>
